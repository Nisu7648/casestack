...
// ============================================
// CASESTACK SERVER (PRODUCTION-READY)
// Enhanced with logging, rate limiting, error handling
// ============================================
...
const casesEmailRoutes = require('./routes/casestack/cases.email');
app.use('/api/cases', casesRoutes);
app.use('/api/cases', casesEmailRoutes);
